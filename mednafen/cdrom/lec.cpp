...
#define calc_mode2_form1_edc(sector) \
...
#define calc_mode2_form2_edc(sector) \
...
#define SET_SYNC_PATTERN(sector) \
   sector[0]  = 0; \
   sector[1]  = 0xff; \
   sector[2]  = 0xff; \
   sector[3]  = 0xff; \
...
#define BIN2BCD(b) ((((b/10) << 4) & 0xf0) | ((b%10) & 0x0f))

/* Builds the sector header.
 */
#define set_sector_header(mode, adr, sector) \
